...
def convex_hull_intersection(p1, p2):
    ...
    if inter_p is not None:
        ...
        try:
            ...
            print("Yes")
        """
        return inter_p, None # hull_inter.volume
    else:
        # print("!!!!!!!!!!!!")
        return None, 0.0  
...
def box3d_iou(corners1, corners2):
    ...
    rect1 = [(inter[i, 0], inter[i, 1]) for i in range(len(inter) - 1, -1, -1)]
    inter_area = poly_area(np.array(rect1)[:, 0], np.array(rect1)[:, 1])
    ...
    # print(iou_2d, inter_area, ymax, ymin, inter_vol, vol1, vol2)
    # print("std 2d area: %f" % inter_area)
    return iou, iou_2d
