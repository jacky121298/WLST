...
def parse_config():
    ...
    parser.add_argument('--state_name', type=str, default='model_state', required=False, help='model state name')
...
def main():
    ...
    if args.pretrained_model is not None:
        model.load_params_from_file(filename=args.pretrained_model, to_cpu=dist, logger=logger, state_name=args.state_name)
