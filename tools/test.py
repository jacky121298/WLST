...
def parse_config():
    ...
    parser.add_argument('--state_name', type=str, default='model_state_dict', required=False, help='model state name')
...
def eval_single_ckpt(model, test_loader, args, eval_output_dir, logger, epoch_id, dist_test=False, state_name='model_state_dict'):
    # load checkpoint
...
def repeat_eval_ckpt(model, test_loader, args, eval_output_dir, logger, ckpt_dir, dist_test=False, state_name='model_state_dict'):
